...
import statsText from '../resource/components/statisticCards'
  ...
  <n-grid :cols="4" :x-gap="16">
    <n-grid-item>
      <n-card class="stat-card">
        <n-statistic :label="statsText.activeUsers.title" :value="summaryData.totalUsers">
          <template #prefix>
    ...
    <n-grid-item>
      <n-card class="stat-card">
        <n-statistic :label="statsText.coursesViewed.title" :value="summaryData.activeUsers">
          <template #prefix>
    ...
    <n-grid-item>
      <n-card class="stat-card">
        <n-statistic :label="statsText.completionRate.title" :value="`${summaryData.completionRate.toFixed(1)}${statsText.completionRate.unit}`">
          <template #prefix>
    ...
    <n-grid-item>
      <n-card class="stat-card">
        <n-statistic :label="statsText.resourcesAccessed.title" :value="summaryData.coursesCount">
          <template #prefix>
